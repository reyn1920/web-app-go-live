...
def _parse_assets(root_element: Any, namespace: Dict[str, str]) -> Dict[str, Dict[str, str]]:
    """
...
def _parse_timeline_events(
    root_element: Any, namespace: dict[str, str], assets: dict[str, dict[str, str]]
) -> list[dict[str, Any]]:
    """
...
def parse_fcpxml(xml_path: str) -> Dict[str, Any]:
    ...
    assets: Dict[str, Dict[str, str]] = _parse_assets(root, namespace)
    events: list[dict[str, Any]] = _parse_timeline_events(root, namespace, assets)
    titles: list[dict[str, float]] = _parse_title_regions(root, namespace)
    vo_regions: list[dict[str, float]] = _detect_voiceover_regions(root, namespace)
